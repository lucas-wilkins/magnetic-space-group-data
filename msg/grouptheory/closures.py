...
def closure(generators: list[MagneticOperation], max_iters=1000) -> list[MagneticOperation]:
    """ Closure of magnetic space groups"""

    output_generators = [MagneticOperation.from_numpy(np.eye(3), np.zeros(3), 1, name="e")]
